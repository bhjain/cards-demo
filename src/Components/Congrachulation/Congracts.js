...
function Congracts() {
    return (
        <div className="w-full my-14 " style={{minHeight: "80vh"}}>
            <div className="congrats flex justify-center mx-auto w-10/12 md:flex-col">
                <div className="congoCard px-10 w-2/5 md:w-full md:px-6 sm:px-2 mx-auto pb-10 h-4/5 sm:hidden" style={{borderRadius: "10px", backgroundColor: "rgba(0, 0, 0, 0.9)"}}>
                ...
                <div className="w-3/5 px-14 lg:px-10 md:w-full md:px-4">
                    <h2 className="font-bold text-5xl text-center py-8 md:text-3xl sm:text-2xl">Congratulations!</h2>
                    <p className="text-sm px-4 pt-4 pb-14">Yes, so please your Majesty. I did go between them, as I said; but more than that, he loved her-for indeed he was mad for her, and talk'd of Satan, and of Limbo, and of Furies, and I know not what.  No, fair Princess; he is the general challenger.  I thank it. More, I prithee, more. I can suck melancholy out of a song, as a weasel sucks eggs.
                    ...
                    <div className="text-center w-3/5 mx-auto bg-white lg:w-4/5 sm:w-full" style={{borderRadius: "50px"}}>
                        ...
                        <p className="font-bold" style={{color: "#C4C4C4"}}>Share your creation</p>
                        ...
                        <p className="font-bold mt-4 mb-10" style={{color: "#C4C4C4"}}>Sell</p>
                    </div>
                </div>
            </div>
        </div>
