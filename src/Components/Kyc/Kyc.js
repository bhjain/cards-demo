    ...
    return (
        <div className="py-10 w-10/12 mx-auto" style={{minHeight: "90vh"}}>
            ...
            <div className="select_drop flex justify-center">
                <div className="dropdown flex w-10/12 justify-between py-6 px-4 items-center" style={{border: "1px solid #C4C4C4", boxSizing: "border-box", borderRadius: "20px"}} onClick={() => {
