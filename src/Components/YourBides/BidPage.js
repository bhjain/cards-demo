        ...
        <div className="w-full mt-10 mb-4" style={{minHeight: "80vh"}}>
            <div className="congrats flex justify-center mx-auto w-10/12 md:flex-col">
                <div className="congoCard px-10 w-2/5 md:w-full md:px-6 sm:px-2 mx-auto pb-10 h-4/5" style={{borderRadius: "10px", backgroundColor: "rgba(0, 0, 0, 0.9)"}}>
                    <h2 className="text-center text-white text-xl font-bold py-6">REVIEW PURCHASE</h2>
                ...
                <div className="w-3/5 px-14 lg:px-10 md:w-full md:px-4 md:text-center">
                    <h2 className="font-bold text-5xl py-6 md:text-3xl" style={{fontWeight: "900"}}>Abstract Art</h2>
                    <div
                    className="w-5/12 py-2 md:py-1 mx-14 md:mx-auto"
                    style={{
                        borderBottom: "1px solid #000000",
                    }}
                    ></div>
                    <p className="px-4 pt-4 pb-4 md:hidden" style={{width: "86%"}}>Reserve Price
                    </p>
                    <p className="px-4 pt-4 pb-4 hidden md:block">Reserve Price
                    </p>
                    <p className="text-3xl" style={{fontWeight: "900"}}>Rs 200</p>

                    <div className="flex gap-4 my-6 md:justify-center">
                        <div className="price_btn flex w-64 justify-center items-center bg-white p-4 mb-2 md:p-3">
                            <h4
                        ...
                        <div className="flex justify-center items-center px-4 py-1" style={{color: "#FFF", backgroundColor: "#000000", borderRadius: "25px"}}>
                            <div className="text-center text-sm">
                            YOUR BALANCE
                            <br />
                            <span className="text-center" style={{fontWeight: "900"}}>2 RS</span>
                            </div>
                        </div>
                    </div>
                    <div className="flex justify-center w-3/5 md:w-full">
                        <Bid back={"#FFFF0A"} color={"#000000"} />
                    </div>
                </div>
            </div>
